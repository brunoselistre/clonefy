...
function Sidebar() {    
    ...
    return ( 
        <div className="text-gray-500 p-5 text-ss lg:text-sm border-r
                        border-gray-900 overflow-scroll scrollbar-hide 
        ...
        >
            <div className="space-y-4">
                ...
                <button className="flex items-center space-x-2 hover:text-red-800" onClick={() => signOut(session)}>
                    <LogoutIcon className="h-5 w-5"/>
                    <p>Logout</p>
                </button>
                <button className="flex items-center space-x-2 hover:text-green-700" onClick={() => window.location.reload()}>
                    <HomeIcon className="h-5 w-5"/>
                    <p>Home</p>
                </button>
                <button className="flex items-center space-x-2 hover:text-green-700">
